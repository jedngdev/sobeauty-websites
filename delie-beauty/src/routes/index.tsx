...
const translations = {
  fr: {
    ...
    hero: {
      ...
      desc: "Ketsia Bitoumbou — spécialiste pose de perruques, funali braids et jayda wayda à Roubaix. Patience, bienveillance, passion à chaque prestation.",
  ...
  en: {
    ...
    hero: {
      ...
      title2: "beauty",
      title3: "and elegance.",
      desc: "Ketsia Bitoumbou — wig install, funali braids and jayda wayda specialist in Roubaix. Patience, care, passion in every appointment.",
      bookNow: "Book now",
      discover: "Discover",
      happy: "Happy clients",
      location: "Roubaix, 59100",
